...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px;">
        ...
        <form action="<?= site_url('Tanggal_merah/aksi_tambah'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-body card-block">
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="date" class="form-control" name="tanggal_merah" required="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
