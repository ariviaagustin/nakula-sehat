                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6>O. Lampiran - Ketentuan-Ketentuan Penyelenggaraan Pelatihan lainnya</h6>
                                </div>
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_ketentuan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Ketentuan-Ketentuan Penyelenggaraan Pelatihan lainnya</label>
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-12" style="text-align: right;">
                                        ...
                                        <button type="submit" class="btn btn-info">Simpan dan Selesai</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    $('#summernote').summernote({
        placeholder: 'Ketentuan-Ketentuan Penyelenggaraan Pelatihan lainnya',
        tabsize: 2,
        height: 200,
        toolbar: [    
            ['edit',['undo','redo']],
