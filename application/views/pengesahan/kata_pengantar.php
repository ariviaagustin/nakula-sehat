                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="kata_pengantar">
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_kata_pengantar'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Isi Kata Pengantar</label>
                                    </div>
