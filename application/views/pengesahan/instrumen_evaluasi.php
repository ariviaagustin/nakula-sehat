                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6>N. Lampiran - Instrumen Evaluasi</h6>
                                </div>
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_instrumen_eval'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Instrumen Evaluasi</label>
                                    </div>
...
<script>
    $('#summernote').summernote({
        placeholder: 'Instrumen Evaluasi',
        tabsize: 2,
        height: 200,
        toolbar: [    
            ['edit',['undo','redo']],
