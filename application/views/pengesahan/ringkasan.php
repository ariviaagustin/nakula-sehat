                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6>H. Bab II - Ringkasan Mata Pelatihan</h6>
                                </div>
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_ringkasan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Ringkasan Mata Pelatihan</label>
                                    </div>
...
<script>
    $('#summernote').summernote({
        placeholder: 'Ringkasan Mata Pelatihan',
        tabsize: 2,
        height: 200,
        toolbar: [    
            ['edit',['undo','redo']],
