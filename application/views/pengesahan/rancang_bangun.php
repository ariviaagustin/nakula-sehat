                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6>K. Lampiran - Rancang Bangun Pembelajaran Mata Pelatihan (RBPMP)</h6>
                                </div>
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_rancang_bangun'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Rancang Bangun Pembelajaran Mata Pelatihan (RBPMP)</label>
                                    </div>
...
<script>
    $('#summernote').summernote({
        placeholder: 'Rancang Bangun Pembelajaran Mata Pelatihan (RBPMP)',
        tabsize: 2,
        height: 200,
        toolbar: [    
            ['edit',['undo','redo']],
