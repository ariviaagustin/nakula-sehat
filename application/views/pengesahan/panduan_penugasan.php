                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6>M. Lampiran - Panduan Penugasan</h6>
                                </div>
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_panduan_penugasan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Panduan Penugasan</label>
                                    </div>
