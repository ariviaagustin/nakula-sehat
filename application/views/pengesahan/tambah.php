...
<div class="container-fluid">
  ...
  <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <form action="<?= site_url('Panduan/aksi_tambah'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="card-body" style="color: #000">
                <div class="card-body card-block">
                        ...
                        <div class="col-12 col-md-9">
                            <select name="id_bagian" class="form-control select2" required="">
                                ...
                                <?php foreach ($kur as $key) { ?>
                                    <option value="<?= $key->id_bagian; ?>"><?= $key->bagian_kurikulum; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea class="form-control" name="isi_panduan" id="summernote"></textarea>
                        </div>
                    </div>
                </div>
            </div>
