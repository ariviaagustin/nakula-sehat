...
<script src="<?= base_url(); ?>agenda/texteditor/ckeditor/plugins/justify/justify.js"></script>
<style type="text/css">
    #content
    {
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_tujuan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Tujuan</label>
                                    </div>
