                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6>J. Bab III - Evaluasi Hasil Belajar</h6>
                                </div>
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_diagram'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Diagram Alur Proses Pelatihan</label>
                                    </div>
                                    <div class="col-12 col-md-12">
                                        <textarea name="isi_bagian_kurikulum" id="txtEditor" rows="10" cols="80">
                                            <?php if($is_kp == 1){ echo $kp->isi_bagian_kurikulum; } ?>
                                        </textarea>
                                        <!-- <textarea class="form-control" id="summernote" name="isi_bagian_kurikulum" required=""><?php if($is_kp == 1){ echo $kp->isi_bagian_kurikulum; } ?></textarea> -->
                                    </div>
                                </div>
                                <div class="row form-group">
