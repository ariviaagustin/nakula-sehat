  ...
  <body style="color: #000">
    ...
    <div class="row">
      <div class="col-md-12" style="text-align: center;">
        <a href="<?= site_url('setujui-pengajuan/'.bin2hex(base64_encode($pengajuan->id_pengajuan))); ?>" class = "btn btn-success btn-sm" title = "Setujui"><i class="fa fa-check-circle"></i> Setujui</a>
        <a href="<?= site_url('tolak-pengajuan/'.bin2hex(base64_encode($pengajuan->id_pengajuan))); ?>" class = "btn btn-danger btn-sm" title = "Tolak"><i class="fa fa-times-circle"></i> Tolak</a>
      </div>
    </div> -->
  </body>
</html>