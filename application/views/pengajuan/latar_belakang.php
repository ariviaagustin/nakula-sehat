                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="latar_belakang">
                            ...
                            <hr>
                            <form action="<?= site_url('Pengajuan/aksi_latar_belakang'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    <div class="col col-md-12">
                                        <label for="text-input" class=" form-control-label">Latar Belakang</label>
                                    </div>
