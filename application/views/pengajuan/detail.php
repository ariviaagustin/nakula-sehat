                ...
                <div class="col-md-6" style="text-align: right;">
                    <?php if($this->session->userdata('is_penilai') == 1){ ?>
                        <?php if($pengajuan->status < 4){ ?>
                            ...
                            <?php } ?>
                            <?php if($pengajuan->kelengkapan < 15){ ?>
                                <a href="#" class = "btn btn-success btn-sm disabled"><i class="fa fa-check-circle"></i> Pengajuan Selesai</a>
                            <?php } ?>
                        <?php } ?>
                    <?php } ?>
                    <?php if($pengajuan->status >= 4 && $pengajuan->status < 100){ ?>
                        ...
                        <a href="<?= site_url('Pengajuan/coba_export_word/'.bin2hex(base64_encode($pengajuan->id_pengajuan))); ?>" class = "btn btn-primary btn-sm" target = "_blank"><i class="fa fa-print"></i> Cetak Kurikulum</a>
                    <?php } ?>
                    ...
                    <?php if($pengajuan->status == 6){ ?>
                        <a href="<?= site_url('cetak-permohonan/'.bin2hex(base64_encode($pengajuan->id_pengajuan))); ?>" class = "btn btn-success btn-sm" title = "Setujui" style = "margin-bottom: 5px;" target = "_blank"><i class="fa fa-download"></i> Unduh Pengesahan</a>
                    <?php } ?>
                ...
                <div style="padding: 5px; margin-bottom: 20px">
                        ...
                        <div class="col-md-6" style="text-align: right;">
                            <?php if($pengajuan->status > 1){ ?>
                                <?php if($pengajuan->status_judul == 0){ ?>
                                    <?php if($this->session->userdata('id_pj_subtansi') == $pengajuan->pj_subtansi){ ?>
                                        <a href="<?= site_url('forum-diskusi/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode(0)).'/'.bin2hex(base64_encode(2)).'/'.bin2hex(base64_encode($this->session->userdata('id_user')))); ?>" class="btn btn-info btn-sm"><i class="fa fa-comments" aria-hidden="true"></i> Diskusikan</a>
                                    <?php } ?>
                                    <?php if($this->session->userdata('id_penilai') == $pengajuan->id_penilai){ ?>
                                        <a href="<?= site_url('forum-diskusi/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode(0)).'/'.bin2hex(base64_encode(1)).'/'.bin2hex(base64_encode($this->session->userdata('id_user')))); ?>" class="btn btn-info btn-sm"><i class="fa fa-comments" aria-hidden="true"></i> Diskusikan</a>
                                    <?php } ?>
                                <?php } ?>
                            <?php } ?>
                            <?php if($this->session->userdata('role') == 4){ ?>
                                <?php if($is_pmbg == 0){ ?>
                                    <?php if($pengajuan->status_judul == 0){ ?>
                                        <?php if($pengajuan->status < 4){ ?>
                                            <a href="<?= site_url('judul-pengajuan/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode(2)).'/'.bin2hex(base64_encode(0))); ?>" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i> Ubah</a>
                                        <?php } ?>
                                    <?php } ?>
                                <?php } ?>
                            <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="space">
                                <h6 style="font-size: 15px"><b>Penilai :</b></h6>
                                <?php if($penilai){ ?>
                                    <span style="margin-left: 15px"><?= $penilai->nama_penilai; ?></span>
                                <?php } ?>
                                <?php if(!$penilai){ ?>
                                    ...
                                    <?php if($pengajuan->status > 1){ ?>
                                        <?php if($kp->status == 0){ ?>
                                            <?php if(date('Y-m-d') >= $jadwal->waktu_mulai && date('Y-m-d') <= $jadwal->waktu_selesai){ ?>
                                                <?php if($this->session->userdata('id_pj_subtansi') == $pengajuan->pj_subtansi){ ?>
                                                    <a href="<?= site_url('forum-diskusi/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode(1)).'/'.bin2hex(base64_encode(2)).'/'.bin2hex(base64_encode($this->session->userdata('id_user')))); ?>" class="btn btn-info btn-sm"><i class="fa fa-comments" aria-hidden="true"></i> Diskusikan</a>
                                                <?php } ?>
                                                <?php if($this->session->userdata('id_penilai') == $pengajuan->id_penilai){ ?>
                                                    <a href="<?= site_url('forum-diskusi/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode(1)).'/'.bin2hex(base64_encode(1)).'/'.bin2hex(base64_encode($this->session->userdata('id_user')))); ?>" class="btn btn-info btn-sm"><i class="fa fa-comments" aria-hidden="true"></i> Diskusikan</a>
                                                <?php } ?>
                                            <?php } ?>
                                        <?php } ?>
                                    <?php } ?>
                                                    ...
                                                    <?php if($bab1a){ ?>
                                                        <?php if($bab1a->status == 0){ ?>
                                                            <?php if(date('Y-m-d') >= $jadwal->waktu_mulai && date('Y-m-d') <= $jadwal->waktu_selesai){ ?>
                                                                <?php if($this->session->userdata('id_pj_subtansi') == $pengajuan->pj_subtansi){ ?>
                                                                    <?php if($pengajuan->status > 1){ ?>
                                                                        <a href="<?= site_url('forum-diskusi/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode($key->id_bagian)).'/'.bin2hex(base64_encode(2)).'/'.bin2hex(base64_encode($this->session->userdata('id_user')))); ?>" class="btn btn-info btn-sm"><i class="fa fa-comments" aria-hidden="true"></i> Diskusikan</a>
                                                                    <?php } ?>
                                                                ...
                                                                <?php if($this->session->userdata('id_penilai') == $pengajuan->id_penilai){ ?>
                                                                    <?php if($pengajuan->status > 1){ ?>
                                                                        <a href="<?= site_url('forum-diskusi/'.bin2hex(base64_encode($pengajuan->id_pengajuan)).'/'.bin2hex(base64_encode($key->id_bagian)).'/'.bin2hex(base64_encode(1)).'/'.bin2hex(base64_encode($this->session->userdata('id_user')))); ?>" class="btn btn-info btn-sm"><i class="fa fa-comments" aria-hidden="true"></i> Diskusikan</a>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                            <?php } ?>
                                                        <?php } ?>
