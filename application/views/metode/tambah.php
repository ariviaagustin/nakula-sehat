...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px;">
        ...
        <form action="<?= site_url('Metode/aksi_tambah'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="card-body" style="padding: 10px; color: #000">
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="radio" name="is_penugasan" required="" value="1"> Penugasan
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="is_penugasan" required="" value="0"> Bukan Penugasan
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
