...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px;">
        <div class="card-header py-3" style="background-color: #fff; color: #000">
            <h5 class="m-0 font-weight-bold" style="font-size: 17px">Verifikasi Ketersediaan Kurikulum</h5>
        </div>
        <div class="card-body" style="padding: 10px; color: #000">
            <div class="card-body card-block">
                ...
                <hr>
                <h6><b>Cek Ketersediaan Kurikulum</b></h6>
                <br>
                <form action="<?= site_url('verifikasi-ketersediaan-kurikulum/'.bin2hex(base64_encode($kurikulum->id_kurikulum))); ?>" method = "get">
                    <div class="row">
                        <div class="col-md-10">
                            <input type="text" name="judul" value="<?= $judul_isi; ?>" class = "form-control" required>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="box">
                    <form action="<?= site_url('aksi-verifikasi-ketersediaan-kurikulum'); ?>" method = "post" enctype="multipart/form-data">
                        ...
                        <div class="row" style="margin-top: 1%; display: none;" id="surat_rekomendasi">
                            <div class="col-md-3">
                                <label><b>Surat Keterangan</b><span style="color: red">*</span></label>
                            </div>
                            <div class="col-md-9">
                                <input type="file" name="surat_rekomendasi" class="form-control" id="input_surat_rekomendasi">
                            </div>
                        </div>
...
<script type="text/javascript">
    $('#tersedia').change(function(){
        $("#surat_rekomendasi").show();
        $("#input_surat_rekomendasi").prop('required',true);
    });
    $('#tidak_tersedia').change(function(){
        $("#surat_rekomendasi").hide();
        $("#input_surat_rekomendasi").prop('required',false);
    });
</script>