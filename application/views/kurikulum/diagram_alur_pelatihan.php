        ...
        <div class="row">
          <div class="col-md-12">
            <?php if($get_catatan){ ?>
              ...
              <hr>
            <?php } ?>
            <h5>Diagram alur proses pelatihan<span style="color: red;">*</span></h5><br>
            <form action="<?= site_url('Kurikulum/aksi_isi_bab_kurikulum'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">  
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="file" class="form-control" name="diagram_alur_proses_pelatihan" <?php if($diagram){ if(!$diagram->diagram_alur_proses_pelatihan){ ?> required <?php } } ?> id="file_foto" onchange="fileValidation_foto()" accept="image/jpg, image/jpeg, image/png" style="margin-bottom: 5px;">
                            <span style="color: red;">*Tipe foto : jpg, jpeg, png</span>
                </div>
              </div>
              <?php if($diagram){ if($diagram->diagram_alur_proses_pelatihan){ ?>
                <div class="row form-group">
                  <div class="col-12 col-md-12">
                    <label>Diagram Alur Proses Pelatihan Sebelumnya:</label><br><br>
              ...
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <textarea class="form-control summernote" name="keterangan" required><?php if($diagram){ if($diagram->keterangan){ echo $diagram->keterangan; } } ?> </textarea>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-10" style="text-align: right;">
                  ...
                  <?php } ?>
                  <?php if($diagram){ ?>
                    <input type="hidden" name="id_diagram_alur_proses_pelatihan" value="<?= $diagram->id_diagram_alur_proses_pelatihan; ?>">
                    <input type="hidden" name="diagram_alur_proses_pelatihan_old" value="<?= $diagram->diagram_alur_proses_pelatihan; ?>">
                  <?php } ?>
