      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <br>
            <h6>Kriteria peserta<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_tambah_kriteria_peserta'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="isi_peserta" required="">
                </div>
              </div>
