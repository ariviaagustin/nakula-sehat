...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px">
        <div class="card-header py-3" style="background-color: #fff">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="m-0 font-weight-bold" style="color: #000; font-size: 17px">Tambah Nilai Instrumen Evaluasi</h5>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <form action="<?= site_url('Kurikulum/aksi_tambah_nilai_instrumen_evaluasi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="card-body">
