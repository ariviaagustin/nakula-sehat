      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <br>
            <h6>Ketentuan Penyelenggara<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_isi_ubah_ketentuan_penyelenggara'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <textarea name="ketentuan_penyelenggara" class="form-control" required><?= $kurikulum->ketentuan_penyelenggara; ?></textarea>
                </div>
              </div>
