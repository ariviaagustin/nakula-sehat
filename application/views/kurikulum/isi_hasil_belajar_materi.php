      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h6>Hasil Belajar<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_isi_hasil_belajar_materi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="hasil_belajar" required="" value="<?= $materi->hasil_belajar; ?>">
                </div>
              </div>
