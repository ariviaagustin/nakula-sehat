      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="<?= site_url('Kurikulum/aksi_tambah_petunjuk_panduan_penugasan_metode'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="petunjuk_panduan_penugasan" required="">
                </div>
              </div>
