...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px;">
        <div class="card-header py-3" style="background-color: #fff; color: #000">
            <h5 class="m-0 font-weight-bold" style="font-size: 17px">Verifikasi Permohonan Kelanjutan Penyusunan Kurikulum</h5>
        </div>
        <div class="card-body" style="padding: 10px; color: #000">
            <div class="card-body card-block">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td>Detail Alasan Dihentikan</td>
                        <td>:</td>
                        <td><?= $kurikulum->keterangan_alasan_hentikan_sistem; ?></td>
                    </tr>
                    <tr>
                ...
                <hr>
                <div class="box">
                    <form action="<?= site_url('Kurikulum/aksi_verifikasi_permohonan_kelanjutan_penyusunan_kurikulum'); ?>" method = "post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-4">
                                <label><b>Verifikasi Permohonan Kelanjutan Penyusunan Kurikulum<span style="color: red">*</span></b></label>
                            </div>
                            <div class="col-md-8">
                                <input type="radio" name="status_dihentikan" value="5" required id="terima"> Terima Permohonan
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="status_dihentikan" value="6" required id="tolak"> Tolak Permohonan
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </div>
                        </div>
                        <div class="row" style="margin-top: 1%; display: none;" id="tambahan_waktu">
                            <div class="col-md-4">
                                <label><b>Tambahan Waktu</b><span style="color: red">*</span></label>
                            </div>
                            <div class="col-md-6">
                                <input type="number" name="tambahan_waktu" class="form-control" id="input_tambahan_waktu">
                            </div>
                            <div class="col-md-2">
                                Minggu
                            </div>
...
<script type="text/javascript">
    $('#terima').change(function(){
        $("#tambahan_waktu").show();
        $("#input_tambahan_waktu").prop('required',true);
    });
    $('#tolak').change(function(){
        $("#tambahan_waktu").hide();
        $("#input_tambahan_waktu").prop('required',false);
    });
</script>
<?php
