      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h6>Kriteria Fasilitator<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_isi_ubah_kriteria_fasilitator'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <textarea name="kriteria_fasilitator" required="" class="form-control"><?= $materi->kriteria_fasilitator; ?></textarea>
                </div>
              </div>
