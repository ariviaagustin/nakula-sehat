      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <br>
            <h6>Sertifikasi<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_isi_ubah_sertifikat'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <textarea name="sertifikat" class="form-control" required><?= $kurikulum->sertifikat; ?></textarea>
                </div>
              </div>
