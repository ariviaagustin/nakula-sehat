      ...
      <div class="card-body card-block">
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="<?= site_url('Kurikulum/aksi_penilaian_panduan_penugasan_praktik_lapang'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group"> 
                <div class="col-md-12">
                  ...
                  <textarea rows="5" name="catatan" required class="form-control"></textarea>
                  <hr>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-10" style="text-align: right;">
                  <?php foreach ($metode_materi as $key) { ?>
                    <input type="hidden" name="id_metode_materi[]" value="<?= $key->id_metode_materi; ?>">
                  <?php } ?>
