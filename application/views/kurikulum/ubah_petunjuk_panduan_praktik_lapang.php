      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="<?= site_url('Kurikulum/aksi_ubah_petunjuk_panduan_praktik_lapang'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="panduan_penugasan" required="" value="<?= $petunjuk->panduan_penugasan; ?>">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12" style="text-align: right;">
                  ...
                  <input type="hidden" name="id_panduan_praktik_lapang" value="<?= $petunjuk->id_panduan_praktik_lapang; ?>">
