      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <br>
            <h6>Jumlah Peserta Pelatihan<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_isi_ubah_jumlah_peserta'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="jumlah_peserta" required="" value="<?= $kurikulum->jumlah_peserta; ?>">
                </div>
              </div>
