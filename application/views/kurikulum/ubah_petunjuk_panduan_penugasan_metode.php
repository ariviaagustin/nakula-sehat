      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <br>
            <h6>Petunjuk<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_ubah_petunjuk_panduan_penugasan_metode'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="petunjuk_panduan_penugasan" required="" value="<?= $petunjuk->petunjuk_panduan_penugasan; ?>">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12" style="text-align: right;">
                  ...
                  <input type="hidden" name="id_petunjuk_panduan_penugasan" value="<?= $petunjuk->id_petunjuk_panduan_penugasan; ?>">
