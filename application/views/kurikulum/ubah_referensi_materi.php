      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <form action="<?= site_url('Kurikulum/aksi_ubah_referensi_materi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="referensi_materi" required="" value="<?= $referensi->referensi_materi; ?>">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12" style="text-align: right;">
                  ...
                  <input type="hidden" name="id_referensi_materi" value="<?= $referensi->id_referensi_materi; ?>">
