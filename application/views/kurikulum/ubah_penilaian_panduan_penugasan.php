              ...
              <?php if($penugasan_materi){ foreach ($penugasan_materi as $key) { ?>
                <div class="col-md-12">
                  ...
                  <table width="100%">
                    ...
                    <tr>
                      <td style="text-align: center;" colspan="2"><h5 style="font-size: 18px;"><b>PANDUAN <?= strtoupper($key->metode); ?></b></h5></td>
                    </tr>
                    <tr>
            ...
            <form action="<?= site_url('Kurikulum/aksi_ubah_penilaian_kurikulum'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">  
              <div class="row form-group"> 
                <div class="col-12 col-md-12">
                  ...
                  <textarea class="form-control ubah" rows="5" name="catatan" placeholder="Berikan Penilaian" data-id = <?= $catatan->id_catatan; ?>><?= $catatan->catatan; ?></textarea>
                </div>
              </div>
