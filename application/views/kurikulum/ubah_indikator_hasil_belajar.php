...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px;">
        ...
        <form action="<?= site_url('Kurikulum/aksi_ubah_indikator_hasil_belajar'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-body card-block">
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" class="form-control" name="indikator_hasil_belajar" required="" value="<?= $indikator_hasil_belajar->indikator_hasil_belajar; ?>" placeholder = "Indikator Hasil Belajar">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3 judul">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" class="form-control" name="materi_sub_materi_pokok" required="" value="<?= $indikator_hasil_belajar->materi_sub_materi_pokok; ?>" placeholder = "Materi Pokok">
                        </div>
                    </div>
                    <?php $total = count($materi_sub_materi_pokok); ?>
                    <?php if($total == 0){ ?>
                    ...
                    <?php } ?>
                    <?php if($total >= 1){ $ds = 1; foreach ($materi_sub_materi_pokok as $val) { ?>
                        <input type="hidden" name="id_isi_materi_sub_materi_pokok[]" value="<?= $val->id_isi_materi_sub_materi_pokok; ?>">
                            ...
                            <div class="form-group multiple-form-group-upload">
                                <div class="form-group m-form__group">
                                    <div class="row form-group">
                                        <div class="col-md-3"></div>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="isi_materi_sub_materi_pokok[]" value="<?php echo $val->isi_materi_sub_materi_pokok; ?>" placeholder = "Sub Materi Pokok">
                                            <span style="color: blue;">Harap diisi satu persatu. Apabila isian lebih dari satu, dapat menambahkan kolom dengan klik tombol tambah disebelah kanan</span>
                                        </div>
                                    </div>
                                    <span class="input-group-btn">
                                        <button type="button"  class="btn btn-<?= ($ds-1 < $total-1) ? 'danger btn-remove hapus-multiple' : 'success btn-add'?>" data-title="d" data-awal="1" data-id="<?=$val->id_isi_materi_sub_materi_pokok?>" style="float: right;"><?= ($ds-1 < $total-1) ? '-' : '+'?></button>
                                    </span>    
                                    <div class="clearfix"></div>           
                                </div>
                            </div>
            ...
            <div class="card-footer" style="background-color: #fff">
                <div class="row form-group">
                    <div class="col-md-12" style="text-align: right;">
                        ...
                        <input type="hidden" name="id_indikator_hasil_belajar" value="<?= $indikator_hasil_belajar->id_indikator_hasil_belajar; ?>">
