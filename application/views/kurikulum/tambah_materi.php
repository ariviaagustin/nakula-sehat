...
<div class="container-fluid">
    <div class="card mb-4" style="border: 0px; padding: 0px">
        <div class="card-header py-3" style="background-color: #fff">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="m-0 font-weight-bold" style="color: #000; font-size: 17px">Tambah Materi</h5>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <form action="<?= site_url('Kurikulum/aksi_tambah_materi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <div class="card-body">
                <div class="card-body card-block">
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="radio" name="jenis_materi" value="1" required=""> Materi Dasar
                            <br>
                            <input type="radio" name="jenis_materi" value="2" required=""> Materi Inti
                            <br>
                            <input type="radio" name="jenis_materi" value="3" required=""> Materi Penunjang
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="number" class="form-control" name="pl" required="">
                        </div>
                    </div>
                    <div class="row form-group">
