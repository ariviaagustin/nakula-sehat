      ...
      <div class="card-body card-block"> 
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h6>Media dan Alat Bantu Materi<span style="color: red;">*</span></h6>
            <form action="<?= site_url('Kurikulum/aksi_ubah_media_alat_bantu_materi'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="row form-group">
                <div class="col-12 col-md-12">
                  <input type="text" class="form-control" name="media_alat_bantu_materi" required="" value="<?= $media_alat_bantu_materi->media_alat_bantu_materi; ?>">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12" style="text-align: right;">
                  ...
                  <input type="hidden" name="id_media_alat_bantu_materi" value="<?= $media_alat_bantu_materi->id_media_alat_bantu_materi; ?>">
