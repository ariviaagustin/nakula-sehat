 ...
 <div class="container-fluid"> 
  <div class="card mb-4" style="border: 0px; padding: 0px;"> 
    <div class="card-header py-3" style="background-color: #fff; color: #000"> 
      <div class="row">
        <div class="col-md-6">
          <h5 class="m-0 font-weight-bold" style="font-size: 17px">Bab I Pendahuluan</h5> 
        </div>
      </div>
    </div> 
        ...
        <div class="row">
          <div class="col-md-12">
            <?php if($get_catatan){ ?>
              ...
              <hr>
            <?php } ?>
            <h5>Bab I Pendahuluan<span style="color: red;">*</span></h5><br>
            <form action="<?= site_url('Kurikulum/aksi_isi_bab_kurikulum'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">  
              <div class="row form-group"> 
                <div class="col-12 col-md-12">
                  <textarea class="form-control summernote" name="pendahuluan" required><?php if($bab_satu_pendahuluan){ echo $bab_satu_pendahuluan->pendahuluan; } ?></textarea> 
                </div>
              </div>
