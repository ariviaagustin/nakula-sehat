              ...
              <div class="row">
                <div class="col-md-12">
                  <table width="100%" border="1">
                    ...
                    <?php if($indikator){ ?>
                      <tr>
                        <td colspan="6">Setelah mengikuti mata pelatihan ini, peserta mampu:</td>
                      </tr>
                      <?php $no = 1; foreach ($indikator as $indi) { ?>
                        <tr>
                          <td style="text-align: center;"><?= $no; ?></td>
                          <td><?= $indi->indikator_hasil_belajar; ?></td>
                          <td>
                              ...
                              <?php
                                ...
                                if($metode)
                                {
                                  foreach ($metode as $get_metode) 
                                  {
                                    ...
                                    $media_tambahan = $this->M_entitas->selectX('media_alat_bantu_tambahan', array('id_metode_materi' => $get_metode->id_metode_materi))->result();
                                    if($media_tambahan)
                                    {
                                      echo "<ul style = 'margin-bottom: 0rem;'>";
            ...
            <form action="<?= site_url('Kurikulum/aksi_ubah_penilaian_kurikulum'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">  
              <div class="row form-group"> 
                <div class="col-12 col-md-12">
                  ...
                  <textarea rows="5" class="form-control ubah" name="catatan" required placeholder="Berikan Penilaian" data-id = <?= $catatan->id_catatan; ?>><?= $catatan->catatan; ?></textarea>
                </div>
              </div>
