...
class Kurikulum extends CI_Controller {
    ...
    public function aksi_tambah()
    {
        ...
        $data = array(
            ...
            'no_surat_pengatar' => $this->input->post('no_surat_pengatar'),
    ...
    public function aksi_verifikasi_ketersediaan_kurikulum()
    {
        ...
        if($ketersediaan_kurikulum == 1)
        {
            ...
            if(isset($_FILES['surat_rekomendasi']['name']))
            {
                $config['upload_path']   = './agenda/perdata/surat_rekomendasi/kurikulum_tersedia/';
                $config['file_name']     = rand(1,9999)."_".$this->input->post('judul_portal')."_".date('YmdHis'); 
                $config['overwrite']     = true;
                $config['allowed_types']     = '*';
                $this->upload->initialize($config);
    ...
    public function aksi_pengesahan_kurikulum()
    {
        ...
        $data = array(
            ...
            'disahkan_oleh' => $this->input->post('disahkan_oleh'),
            'nip_disahkan_oleh' => $this->input->post('nip_disahkan_oleh'),
            'jabatan_disahkan_oleh' => $this->input->post('jabatan_disahkan_oleh'),
